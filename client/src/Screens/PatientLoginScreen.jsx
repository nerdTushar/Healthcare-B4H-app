...
const PatientLoginScreen = () => {
  return (
    <>
    <div className='min-h-0 py-20 bg-gradient-to-br from-[#003a70] to-[#35b6b4]'>
      <div className='container mx-auto'>
         <div className='flex flex-col lg:flex-row w-11/12 lg:w-8/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden'>
            <div className='w-full lg:w-1/2 flex flex-col items-center justify-center p-12 bg-no-repeat bg-cover bg-center' style={{backgroundImage: `url("images/PatientEHR.jpg")` }}>
               <h1 className='text-[#003a70] hover:text-white font-bold text-2xl lg:text-3xl mb-3'>Welcome To</h1>
               <div>
                <p className='text-[#003a70] hover:text-white font-bold text-2xl lg:text-3xl'>Patient EHR</p>
               </div>
            </div>
            <div className='w-full lg:w-1/2 lg:py-16 py-12 px-12'>
               <div className='flex justify-between items-center'>
               <h2 className='lg:text-3xl text-2xl font-bold text-[#003a70] hover:text-[#35b6b4] mb-4'>Patient Login</h2>
               <img src='../images/patienticon.jpg' alt='Patient Icon' 
               className='rounded-full lg:w-24 w-16' />
               </div>
               <p className='mb-4 mt-4'>
                Login your account. It's free and only take a minute
               </p>
               <form action='#'>
                 {/* <div className='grid grid-cols-2 gap-5'>
                    <input type='text' placeholder='First Name' className='
                  border-solid border-x-2 rounded border-y-2 border-[#003a70] valid:border-[#003a70] focus:border-[#003a70] py-1 px-2'/>
                    <input type='text' placeholder='Last Name' className='
                    border-solid border-x-2 rounded border-y-2 border-[#003a70] py-1 px-2'/>
                 </div> */}
                 <div className='mt-5'>
                 ...
                 <div className='mt-5'>
                    <button className='w-full bg-[#003a70] rounded hover:bg-[#35b6b4] py-3 text-center text-white'>Login</button>
                 </div>
               </form>
               <div className='mt-5'>
                  <h2>Don't patient have an account ?
                  <NavLink to='/patientregister' className='text-[#35b6b4] ml-2 hover:text-[#003a70] font-bold'>
                     Register
                  </NavLink>
                  </h2>
               </div>
