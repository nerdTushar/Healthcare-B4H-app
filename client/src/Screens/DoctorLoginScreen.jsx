     ...
     <div className='container mx-auto'>
        <div className='flex flex-col lg:flex-row w-11/12 lg:w-8/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden'>
           ...
           <div className='w-full lg:w-1/2 lg:py-16 py-12 px-12'>
              ...
              <h2 className='lg:text-3xl text-2xl font-bold text-[#003a70] hover:text-[#35b6b4] mb-4'>Doctor Login</h2>
              ...
              <div className='mt-5'>
                 <h2>Don't doctor have an account ?
                 <NavLink to='/doctorregister' className='text-[#35b6b4] ml-2 hover:text-[#003a70] font-bold'>
                    Register
                 </NavLink>
                 </h2>
              </div>
